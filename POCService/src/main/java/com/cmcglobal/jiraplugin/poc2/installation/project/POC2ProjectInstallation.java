package com.cmcglobal.jiraplugin.poc2.installation.project;
...
@ExportAsService({POC2ProjectInstallation.class})
@Named
public class POC2ProjectInstallation extends AbstractProjectInstallation {

    @Inject
    public POC2ProjectInstallation(IProjectUtils projectUtils) {
        super(projectUtils);
    }
