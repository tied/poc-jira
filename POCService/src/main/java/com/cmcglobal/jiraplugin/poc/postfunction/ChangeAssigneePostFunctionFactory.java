...
public class ChangeAssigneePostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public ChangeAssigneePostFunctionFactory(WorkflowManager workflowManager) {
