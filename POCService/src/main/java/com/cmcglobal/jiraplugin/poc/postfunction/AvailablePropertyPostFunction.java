 ...
 */
public class AvailablePropertyPostFunction extends AbstractJiraFunctionProvider {
    ...
    public void execute(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
        ...
        if (issue.getStatus().getName().equalsIgnoreCase("Pending Shopping") ||
                issue.getStatus().getName().equalsIgnoreCase("Pending Inventory")) {
            try {
                ...
                subTaskIssueService.createReceiveSubTask(issue, map);
            } catch (Exception e) {
                e.printStackTrace();
