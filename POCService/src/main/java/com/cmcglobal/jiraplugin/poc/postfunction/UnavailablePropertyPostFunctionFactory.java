...
public class UnavailablePropertyPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public UnavailablePropertyPostFunctionFactory(WorkflowManager workflowManager) {
