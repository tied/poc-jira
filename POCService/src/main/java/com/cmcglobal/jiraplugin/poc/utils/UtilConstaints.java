...
public class UtilConstaints {
    public static String USERNAME = "crm-system";
    ...
    public static String ERROR_FILENOTFOUND = "File do not found!";
    public static String ERROR_IMPORTXMLFAIL = "Error during import XML file!";
    public static String ERROR_PARAMINPUTINVALID = "Input parameters invalid!";
    public static String ERROR_CUSTOMFIELD_CREATEVALIDATEFAIL = "Validate create CustomField fail!";
    ...
    public static String ERROR_ISSUETYPE_UPDATEVALIDATEFAIL = "Validate update Issue Type fail!";
    public static String ERROR_PROJECT_CREATEVALIDATEFAIL = "Validate create project fail!";
    public static String ERROR_PROJECT_DELETEVALIDATEFAIL = "Validate delete project fail!";
    public static String ERROR_PROJECT_UPDATEVALIDATEFAIL = "Validate update project fail!";
}
