...
@ExportAsService({FieldInstallation.class})
@Named
public class FieldInstallation extends AbstractFieldInstallation {

    @Inject
    public FieldInstallation(ICustomFieldUtils customFieldUtils) {
