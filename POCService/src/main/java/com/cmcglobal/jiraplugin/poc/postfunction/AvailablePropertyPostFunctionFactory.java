...
public class AvailablePropertyPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public AvailablePropertyPostFunctionFactory(WorkflowManager workflowManager) {
