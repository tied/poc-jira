...
public class DoneSubtaskPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public DoneSubtaskPostFunctionFactory(WorkflowManager workflowManager) {
