...
public class FinishShoppingPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public FinishShoppingPostFunctionFactory(WorkflowManager workflowManager) {
