...
public class RejectSubtaskPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public RejectSubtaskPostFunctionFactory(WorkflowManager workflowManager) {
